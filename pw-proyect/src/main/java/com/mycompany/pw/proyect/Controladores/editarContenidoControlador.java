 ...
 * @author mike_
 */
@WebServlet(name = "editarContenidoControlador", urlPatterns = {"/editarContenidoControlador"})
public class editarContenidoControlador extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet editarContenidoControlador</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet editarContenidoControlador at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int idNoticia = Integer.parseInt(request.getParameter("idNoticiaContendio"));
        String Contenido = request.getParameter("Contenido");

        if (!noticiaDao.editarDescripcionNoticia(idNoticia, Contenido)) {
