 ...
 * @author mike_
 */
@WebServlet(name = "aporvarNoticiaControlador", urlPatterns = {"/aporvarNoticiaControlador"})
public class aporvarNoticiaControlador extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet aporvarNoticiaControlador</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet aporvarNoticiaControlador at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String _nombreUsuario = request.getParameter("usuarioAprovacion");
        usuario.setNombreUsuario(_nombreUsuario);

        int idNoticia = Integer.parseInt(request.getParameter("idNoticiaAprovacion"));
