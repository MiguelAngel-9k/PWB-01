 ...
 * @author mike_
 */
@WebServlet(name = "editarCategoriaControlador", urlPatterns = {"/editarCategoriaControlador"})
public class editarCategoriaControlador extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet editarCategoriaControlador</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet editarCategoriaControlador at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int idNoticia = Integer.parseInt(request.getParameter("idNoticiaCategoria"));
        String Categoria = request.getParameter("Categoria");

        if (!noticiaDao.editarCategoriaNoticia(idNoticia, Categoria)) {
